...
general_cfg.loss_weights['depth'] = 10
general_cfg.loss_weights['semantic'] = 0
general_cfg.loss_weights['bbox'] = 0

general_cfg.no_classes = 8
general_cfg.no_bbox_classes = 8
...
HRnet_cfg['STAGE3']['NUM_BRANCHES'] = 4
# HRnet_cfg['STAGE3']['NUM_BLOCKS'] = [4, 4, 4]
HRnet_cfg['STAGE3']['NUM_BLOCKS'] = [1, 1, 1, 1]
#HRnet_cfg['STAGE3']['NUM_CHANNELS'] = [18, 36, 72, 144]
HRnet_cfg['STAGE3']['NUM_CHANNELS'] = [9, 18, 36, 72]
HRnet_cfg['STAGE3']['BLOCK'] = 'BASIC'
HRnet_cfg['STAGE3']['FUSE_METHOD'] = 'SUM'
...
MTI_cfg.backbone_channels=[9, 18, 36, 72]
