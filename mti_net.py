...
class MTINet(nn.Module):
    ...
    def __init__(self, cfg, backbone):
        ...
        # General
        self.tasks = cfg.TASKS.NAMES
        self.auxilary_tasks = cfg.AUXILARY_TASKS.NAMES
        self.channels = cfg.backbone_channels 
        ...
        self.scale_0 = InitialTaskPredictionModule(cfg, self.auxilary_tasks, self.channels[0] + self.channels[1], self.channels[0])
        self.scale_1 = InitialTaskPredictionModule(cfg, self.auxilary_tasks, self.channels[1] + self.channels[2], self.channels[1])
        self.scale_2 = InitialTaskPredictionModule(cfg, self.auxilary_tasks, self.channels[2] + self.channels[3], self.channels[2])
        self.scale_3 = InitialTaskPredictionModule(cfg, self.auxilary_tasks, self.channels[3], self.channels[3])
    ...
    def forward(self, x):
        ...
        out['multi_scale_features'] = {'scale_0': features_0, 'scale_1': features_1, 'scale_2': features_2, 'scale_3': features_3}
